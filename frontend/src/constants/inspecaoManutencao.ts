import { InspecaoManutencao, ItemInspecao, RespostaBinaria } from '../types/manutencao';
  ...
  secoes: [
    {
      secao: 'certificacoes',
      itens: [
        { id: 'cert_1', titulo: 'Placa de identificação e/ou TAG estão legíveis?' },
        { id: 'cert_2', titulo: 'Certificações do equipamento estão válidas?' },
        {
          id: 'cert_3',
          titulo: 'Certificados de instrumentos (manômetros, etc.) estão dentro da validade?',
        },
      ],
    },
    {
      ...
      itens: [
        {
          id: 'estr_1',
          titulo: 'A estrutura do equipamento está íntegra e em boas condições de uso?',
        },
        { id: 'estr_2', titulo: 'A estrutura base/skid está sem deformações?' },
        { id: 'estr_3', titulo: 'A pintura ou tratamento da carcaça está adequado?' },
        { id: 'estr_4', titulo: 'Todos os componentes estão íntegros?' },
        {
          id: 'estr_5',
          titulo: 'Parafusos, porcas, abraçadeiras e fixações estão bem apertados e íntegros?',
        },
        { id: 'estr_6', titulo: 'Flanges e conexões mecânicas estão íntegros?' },
        { id: 'estr_7', titulo: 'Tambor, cone ou carcaças estão sem danos ou corrosão?' },
        {
          id: 'estr_8',
          titulo: 'Molas, peneiras, sapatas e demais partes mecânicas estão íntegras?',
        },
      ],
    },
    {
      ...
      itens: [
        ...
        { id: 'hid_3', titulo: 'As mangueiras hidráulicas estão sem vazamentos?' },
        { id: 'hid_4', titulo: 'As mangueiras hidráulicas estão em boas condições de uso?' },
        { id: 'hid_5', titulo: 'O sistema hidráulico está funcionando adequadamente?' },
    ...
    },
    {
      ...
      itens: [
        ...
        {
          id: 'elet_5',
          titulo: 'O sistema de aterramento (equipotencialização) está adequado?',
        },
        { id: 'elet_6', titulo: 'Disjuntores e dispositivos DR estão operacionais?' },
        { id: 'elet_7', titulo: 'O motor elétrico está em conformidade para operação?' },
      ],
    },
    {
      secao: 'dispositivoSeguranca',
      itens: [
        { id: 'seg_1', titulo: 'O botão de emergência está íntegro e operacional?' },
        { id: 'seg_2', titulo: 'O sistema de parada de emergência está operacional?' },
        {
          id: 'seg_3',
          titulo: 'O dispositivo anti-chicoteamento (configuração 8) está instalado e operacional?',
        },
        { id: 'seg_4', titulo: 'As proteções (grades/carenagens) estão íntegras?' },
        { id: 'seg_5', titulo: 'Gatilhos de segurança e travas estão funcionando?' },
      ],
    },
    {
      ...
      itens: [
        ...
        {
          id: 'comp_4',
          titulo: 'Rotor, bombas e componentes internos estão livres e desobstruídos?',
        },
        { id: 'comp_5', titulo: 'Os acoplamentos estão bem fixados?' },
        { id: 'comp_6', titulo: 'As válvulas (by-pass, alívio, etc.) estão operacionais?' },
        { id: 'comp_7', titulo: 'Os manômetros estão íntegros e operacionais?' },
        { id: 'comp_8', titulo: 'Os filtros estão limpos e adequados?' },
        { id: 'comp_9', titulo: 'O sistema de resfriamento/trocador de calor está funcional?' },
      ],
    },
    {
      secao: 'acessorios',
      itens: [
        ...
        { id: 'acess_2', titulo: 'A fixação de cabos e ganchos está adequada?' },
        { id: 'acess_3', titulo: 'Rodas e sistemas de locomoção estão funcionais?' },
        {
          id: 'acess_4',
          titulo: 'Câmeras, sensores e monitores estão operacionais?',
        },
        { id: 'acess_5', titulo: 'Iluminação/luminárias estão funcionando corretamente?' },
        { id: 'acess_6', titulo: 'Bicos, esguichos e pistolas estão operacionais?' },
        { id: 'acess_7', titulo: 'Reservatórios estão íntegros e com nível adequado?' },
      ],
    },
    {
      ...
      itens: [
        ...
        { id: 'teste_3', titulo: 'O equipamento apresenta aquecimento excessivo?' },
...
const CHECKLIST_CAVALETE_AR_MANDADO: ChecklistTemplate = {
  ...
  secoes: [
    {
      secao: 'estruturaMecanica',
      itens: [{ id: 'estr_1', titulo: 'A estrutura do equipamento encontra-se em boa condição de uso?' }],
    },
    {
      secao: 'certificacoes',
      itens: [
        { id: 'cert_1', titulo: 'Placa de identificação e TAG estão legíveis?' },
        { id: 'cert_2', titulo: 'Todas as certificações encontram-se dentro do prazo de validade?' },
      ],
    },
    {
      secao: 'sistemaPneumatico',
      itens: [
        {
          id: 'pneu_1',
          titulo: 'As conexões e sistema de ar encontram-se em boas condições de uso?',
        },
      ],
    },
    {
      ...
      itens: [
        { id: 'comp_1', titulo: 'O equipamento encontra-se limpo?' },
        { id: 'cav_filtro_condicao', titulo: 'O filtro da unidade está em boa condição de uso?' },
        {
          id: 'cav_filtro_validade',
          titulo: 'O filtro está dentro da validade ou atenderá todo o período da operação?',
        },
    ...
    },
    {
      ...
      itens: [
        {
          id: 'seg_3',
          titulo: 'O dispositivo anti-chicoteamento na configuração 8 está operacional?',
        },
      ],
    },
    {
  ...
  secoes: [
    {
      secao: 'estruturaMecanica',
      itens: [
        { id: 'estr_1', titulo: 'A estrutura do equipamento encontra-se em boas condições de uso?' },
      ],
    },
    {
      secao: 'certificacoes',
      itens: [{ id: 'cert_1', titulo: 'Placa de identificação e TAG estão legíveis?' }],
    },
    {
      secao: 'sistemaHidraulico',
      itens: [
  ...
  secoes: [
    {
      ...
      itens: [
        { id: 'estr_1', titulo: 'A estrutura do equipamento encontra-se em boas condições de uso?' },
        { id: 'estr_5', titulo: 'Os parafusos da estrutura e abraçadeiras estão íntegros?' },
      ],
    },
    {
      secao: 'certificacoes',
    ...
    },
    {
      ...
      itens: [
        {
          id: 'pneu_1',
          titulo: 'As conexões e sistema de ar da bomba encontram-se em boas condições de uso?',
        },
      ],
    },
    {
  ...
  secoes: [
    {
      ...
      itens: [
        { id: 'estr_1', titulo: 'A estrutura do equipamento encontra-se em boas condições de uso?' },
        { id: 'estr_5', titulo: 'Os parafusos da estrutura e abraçadeiras estão íntegros?' },
        { id: 'estr_6', titulo: 'O flange e conexão de recalque estão íntegros e operacionais?' },
      ],
    },
    {
      secao: 'certificacoes',
    ...
    },
    {
      ...
      itens: [
        { id: 'comp_1', titulo: 'O equipamento encontra-se limpo?' },
        { id: 'comp_4', titulo: 'A bomba está com rotor íntegro e desobstruído?' },
      ],
    },
    {
      secao: 'sistemaHidraulico',
      itens: [
        {
          id: 'hid_5',
          titulo: 'As conexões e sistema hidráulico encontram-se em boas condições de uso?',
        },
      ],
    },
    {
  ...
  secoes: [
    {
      secao: 'certificacoes',
      itens: [
        { id: 'cert_1', titulo: 'As placas de identificação e TAG estão legíveis?' },
    ...
    },
    {
      ...
      itens: [
        ...
        { id: 'acess_2', titulo: 'A fixação do cabo no gancho de içamento está adequada para operação?' },
        {
    ...
    },
    {
      secao: 'estruturaMecanica',
      itens: [
        { id: 'estr_7', titulo: 'Aparentemente o tambor está íntegro (sem corrosão, danos)?' },
        { id: 'estr_6', titulo: 'As conexões estão em condições ideais de uso?' },
        { id: 'estr_8', titulo: 'As sapatas estão íntegras (sem desgaste excessivo)?' },
      ...
      itens: [
        {
          ...
          titulo: 'A haste de controle retorna para a posição neutra quando é solta?',
        },
        {
  ...
  secoes: [
    {
      ...
      itens: [
        { id: 'estr_1', titulo: 'A estrutura do equipamento encontra-se em boas condições de uso?' },
        { id: 'estr_5', titulo: 'Todos os parafusos e conexões estão bem fixados?' },
      ],
    },
    {
      secao: 'certificacoes',
    ...
    },
    {
      ...
      itens: [
        ...
        { id: 'seg_1', titulo: 'O botão de emergência está íntegro e operacional?' },
        { id: 'seg_5', titulo: 'O gatilho de segurança da pistola está íntegra e operacional?' },
        {
          id: 'seg_3',
          titulo: 'O dispositivo anti-chicoteamento na configuração 8 está operacional?',
        },
    ...
    },
    {
      ...
      itens: [
        { id: 'elet_3', titulo: 'O painel elétrico está íntegro?' },
        { id: 'elet_6', titulo: 'Contém dispositivo diferencial residual (DR)?' },
        {
          id: 'hidro_plug_atex',
          titulo: 'O plugue elétrico é para a área classificada (ATEX) e está íntegro?',
        },
        { id: 'hidro_motor_explosao', titulo: 'O motor elétrico é a prova de explosão?' },
        {
          id: 'elet_5',
          titulo: 'Ponto de equipotencialização (terra) está visível e bem fixado?',
        },
    ...
    },
    {
      secao: 'acessorios',
      itens: [
        { id: 'acess_3', titulo: 'As rodas de locomoção estão íntegras e funcionais?' },
        { id: 'acess_6', titulo: 'A pistola de alta pressão está íntegra e funcional?' },
      ],
    },
    {
      secao: 'sistemaHidraulico',
      itens: [
        { id: 'hid_7', titulo: 'O nível de óleo da bomba está na condição de operacionalidade?' },
        { id: 'hid_3', titulo: 'As mangueiras estão íntegras e sem vazamentos?' },
      ],
    },
    {
      secao: 'componentesOperacionais',
  ...
  secoes: [
    {
      secao: 'certificacoes',
      itens: [
        { id: 'cert_1', titulo: 'As placas de identificação do equipamento e/ou TAG estão legíveis?' },
      ],
    },
    {
      secao: 'sistemaHidraulico',
      itens: [
        ...
        },
        {
          ...
          titulo: 'Foi necessária a substituição do óleo do sistema? (Óleo ISO VG68)',
        },
        {
        ...
        {
          id: 'teste_3',
          titulo: 'Houve algum aquecimento excessivo da máquina durante a operação na base?',
        },
        { id: 'hid_8', titulo: 'A vazão da máquina está adequada para operação?' },
        {
          id: 'hid_4',
          titulo: 'As conexões e mangueiras estão íntegras e adequadas para operação?',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      itens: [
        {
          id: 'estr_3',
          titulo: 'A pintura ou tratamento da carcaça está adequada para operação?',
        },
      ],
    },
    {
  ...
  secoes: [
    {
      secao: 'certificacoes',
      itens: [
        { id: 'cert_1', titulo: 'As placas de identificação do equipamento e TAG estão legíveis?' },
      ],
    },
    {
      secao: 'sistemaHidraulico',
      ...
      itens: [
        {
          ...
          titulo: 'Haverá necessidade de troca de algum componente durante o teste?',
        },
      ],
    },
    {
  ...
  secoes: [
    {
      ...
      itens: [
        ...
        {
          id: 'lum_classe_grupo',
          titulo: 'A classe do equipamento e o grupo está adequado para operação?',
        },
      ],
    },
    {
    ...
    },
    {
      secao: 'sistemaPneumatico',
      itens: [
        { id: 'pneu_2', titulo: 'O sistema pneumático está íntegro (sem vazamento)?' },
      ],
    },
    {
      secao: 'sistemaEletrico',
      itens: [
        {
          ...
          titulo: 'O cabo e plugs estão com a limpeza e higienização adequados para operação?',
        },
        {
        ...
        },
        {
          ...
          titulo: 'O dispositivo de respiro e drenagem estão adequados para operação?',
        },
        {
          id: 'elet_5',
          titulo:
    ...
    },
    {
      secao: 'testesOperacionais',
      itens: [
        { id: 'lum_ligou_normal', titulo: 'Após ligar, a luminária ligou normalmente?' },
        { id: 'teste_5', titulo: 'O equipamento está operacional?' },
      ],
    },
  ],
  ...
  secoes: [
    {
      secao: 'certificacoes',
      itens: [
        { id: 'cert_1', titulo: 'A placa de identificação e TAG estão legíveis?' },
        { id: 'cert_3', titulo: 'O certificado do manômetro está dentro da validade?' },
        { id: 'man_cert_estrutura', titulo: 'A certificação da estrutura está dentro da validade?' },
      ],
    },
    {
      secao: 'estruturaMecanica',
...
const CHECKLIST_ROBO_LOMBRICO_ROV: ChecklistTemplate = {
  ...
  secoes: [
    ...
    },
    {
      secao: 'sistemaHidraulico',
      itens: [
        { id: 'hid_2', titulo: 'As mangueiras hidráulicas estão fixadas ao robô?' },
        {
          id: 'hid_7',
          titulo: 'O nível de óleo da unidade está na condição de operacionalidade?',
        },
        {
    ...
    },
    {
      secao: 'acessorios',
      itens: [
        { id: 'rov_esteira', titulo: 'A esteira de locomoção está íntegra e operacional?' },
        ...
        {
          id: 'rov_cadeira',
          titulo: 'A cadeira de assento está íntegra e seus ajustes operacionais?',
        },
        { id: 'rov_bicos_esguicho', titulo: 'Os bicos de esguicho estão bem fixados e operacionais?' },
        {
          id: 'acess_7',
          titulo: 'O reservatório de água para limpeza das câmeras está em nível operacional?',
        },
      ],
    },
    {
      ...
      itens: [
        {
          ...
          titulo: 'Os comandos de acionamento e controle do equipamento estão operacionais?',
        },
        { id: 'rov_descompactador', titulo: 'O descompactador está íntegro e operacional?' },
  ...
  secoes: [
    {
      ...
      itens: [
        ...
        { id: 'shaker_molas', titulo: 'As molas do sistema mecânico estão íntegras para operação?' },
      ],
    },
    {
      secao: 'certificacoes',
    ...
    },
    {
      secao: 'componentesOperacionais',
      itens: [
        { id: 'shaker_skimmer', titulo: 'O skimmer está em boas condições para operação?' },
        { id: 'shaker_manoplas', titulo: 'As manoplas de acionamento estão operacionais?' },
      ],
    },
    {
      secao: 'acessorios',
    ...
    },
    {
      secao: 'sistemaEletrico',
      itens: [
        { id: 'shaker_botoeiras', titulo: 'As botoeiras do painel estão operacionais?' },
        { id: 'elet_3', titulo: 'O painel elétrico está íntegro?' },
        ...
        { id: 'elet_1', titulo: 'O cabo elétrico está íntegro?' },
        { id: 'elet_6', titulo: 'Os disjuntores e DRs estão operacionais e fixados?' },
      ],
    },
    {
      secao: 'testesOperacionais',
...
const CHECKLIST_SOPRADOR_PNEUMATICO: ChecklistTemplate = {
  ...
  secoes: [
    {
      secao: 'certificacoes',
      itens: [{ id: 'cert_1', titulo: 'A placa de identificação e TAG estão legíveis?' }],
    },
    {
      secao: 'estruturaMecanica',
      itens: [
        { id: 'estr_7', titulo: 'A estrutura do cone está íntegra?' },
        { id: 'estr_2', titulo: 'A estrutura da base está íntegra e sem deformações?' },
      ],
    },
    {
      secao: 'sistemaPneumatico',
...
const CHECKLIST_WPU_UNIDADE_LAVADORA: ChecklistTemplate = {
  ...
  secoes: [
    ...
    },
    {
      secao: 'componentesOperacionais',
      itens: [
        { id: 'comp_7', titulo: 'O manômetro de pressão está em conformidade?' },
        ...
        {
          id: 'comp_3',
          titulo: 'Os rolamentos das bombas centrífugas estão sem ruído anormal?',
        },
        {
    ...
    },
    {
      ...
      itens: [
        ...
        },
        {
          ...
          titulo: 'A corrente elétrica do motor está menor ou igual a 19A e maior ou igual a 18A?',
        },
        {
          id: 'wpu_tomadas_plugs',
          titulo: 'As tomadas, cabeamentos e plugs estão íntegras para operação?',
        },
      ],
    },
    {
    ...
    },
    {
      secao: 'estruturaMecanica',
      itens: [
        { id: 'estr_2', titulo: 'A estrutura está íntegra e sem deformações (skid)?' },
      ],
    },
    {
      secao: 'dispositivoSeguranca',
      itens: [
        {
          id: 'seg_3',
          titulo: 'O dispositivo anti-chicoteamento está instalado na configuração 8 e operacional?',
        },
      ],
    },
    {
...
const CHECKLISTS_POR_EQUIPAMENTO: Record<string, ChecklistTemplate> = {
  ...
  [normalizarChave('Hidrojato de alta pressão')]: CHECKLIST_HIDROJATO_ALTA_PRESSAO,
...
const buscarChecklistPorValor = (valor?: string) => {
  ...
  const match = chavesDisponiveis.find((key) => chave.includes(key) || key.includes(chave));

  return match ? CHECKLISTS_POR_EQUIPAMENTO[match] : undefined;
};

export const obterChecklistManutencao = (params: ChecklistManutencaoParams = {}) => {
  return (
...
export const aplicarChecklistManutencao = (
  ...
  const secoesMap = new Map(checklist.secoes.map((secao) => [secao.secao, secao]));
  ...
  const montarItens = (secaoConfig: SecaoInspecaoConfig) => {
    ...
    return construirItens(secaoConfig, template.itens, inspecao[secaoConfig.key]);
  };
